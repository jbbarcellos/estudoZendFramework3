# Repositório com aplicação Web utilizando Zend framework 3
...
config/autoload/DumpMySQL ==> Dump do banco de dados;
config/autoload/global.php ==> parametros do banco de dados;
config/autoload/development.local.php ==> usuário e senha banco de dados;
